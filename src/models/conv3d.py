"""
Explore performance of more novel 3d convolutional networks on 3d brain scans
"""
import os
import pickle
...
class BasicStem(nn.Sequential):
    ...
    def __init__(self, num_channels: int = 1):
        super(BasicStem, self).__init__(
            nn.Conv3d(num_channels, 64, kernel_size=(3, 7, 7), stride=(1, 2, 2),
...
class R2Plus1dStem(nn.Sequential):
    ...
    def __init__(self, num_channels: int = 1):
        super(R2Plus1dStem, self).__init__(
            nn.Conv3d(num_channels, 45, kernel_size=(1, 7, 7),
